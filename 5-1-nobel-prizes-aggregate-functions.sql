...
*/
SELECT COUNT(winner)  AS winners
FROM nobel
...
*/
SELECT subject, COUNT(winner) AS winners
FROM nobel
GROUP BY subject
...
*/
SELECT subject, MIN(yr) AS 'first year'
FROM nobel
GROUP BY subject
...
*/
SELECT subject, COUNT(*) AS prizes
FROM nobel
WHERE yr = '2000'
GROUP BY subject
...
*/
SELECT subject, COUNT(DISTINCT winner) AS winners
FROM nobel
GROUP BY subject
...
*/
SELECT subject, COUNT(DISTINCT yr) as 'times awarded'
FROM nobel
GROUP BY subject
