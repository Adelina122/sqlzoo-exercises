/*
Table:
world(name, continent, capital, area, population, gdp)
*/
...
*/
SELECT name, ROUND(population/1000000.0,2) AS 'population, M', 
ROUND(gdp/1000000000.0,2) AS 'gdp, B'
FROM world 
WHERE continent = 'South America'
...
*/
SELECT name, ROUND(gdp/population, -3) AS 'gdp, T'
FROM world
